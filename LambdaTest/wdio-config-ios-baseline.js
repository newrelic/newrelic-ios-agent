...
function generateDynamicBuildName() {
  ...
  return `Build_NRTestApp_Baseline - iOS:${now}`;
}
...
exports.config = {
  ...
  maxInstances: 1, // Run sequentially for baseline test
  capabilities: [
    {
      "lt:options": {
        w3c: true,
        ...
        name: "Session Replay Performance - BASELINE (Session Replay OFF) - Real Device",
        network: true,
        devicelog: true,
        visual: true,
      },
