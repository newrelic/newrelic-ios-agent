...
#ifndef NEWRELIC_SWIFT_H
#define NEWRELIC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NewRelic",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSDate;
@class NSString;
SWIFT_CLASS("_TtC8NewRelic17JSErrorController")
@interface JSErrorController : NSObject
- (nullable instancetype)initWithAnalyticsController:(id _Nonnull)analyticsController sessionStartTime:(NSDate * _Nonnull)sessionStartTime agentConfiguration:(id _Nonnull)agentConfiguration platform:(NSString * _Nonnull)platform sessionId:(NSString * _Nonnull)sessionId attributeValidator:(id _Nonnull)attributeValidator OBJC_DESIGNATED_INITIALIZER;
- (void)recordJSError:(NSString * _Nonnull)name message:(NSString * _Nonnull)message stackTrace:(NSString * _Nonnull)stackTrace isFatal:(BOOL)isFatal additionalAttributes:(NSDictionary<NSString *, id> * _Nullable)additionalAttributes;
- (void)onHarvestStart;
...
///
/// returns:
/// Array of error dictionaries currently in the queue
- (NSArray<NSDictionary<NSString *, id> *> * _Nonnull)getErrorQueueForTesting SWIFT_WARN_UNUSED_RESULT;
/// Internal method for testing: clears the error queue
- (void)clearErrorQueueForTesting;
/// Internal method for testing: returns the current size of the error queue
- (NSInteger)errorQueueSizeForTesting SWIFT_WARN_UNUSED_RESULT;
/// Internal method for testing: clears persisted errors from disk
- (void)clearPersistedErrorsForTesting;
