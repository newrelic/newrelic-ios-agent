//
 ...
 extension String {
     ...
     public enum SwifterFileError: Error {
         case error(Int32)
     }

     public class SwifterFile {

         public let pointer: UnsafeMutablePointer<FILE>
         ...
         public func read(_ data: inout [UInt8]) throws -> Int {
             ...
             if ferror(self.pointer) != 0 {
                 throw SwifterFileError.error(errno)
             }
             throw SwifterFileError.error(0)
         }
     ...
     public func openNewForWriting() throws -> SwifterFile {
         return try openFileForMode(self, "wb")
     }

     public func openForReading() throws -> SwifterFile {
         return try openFileForMode(self, "rb")
     }

     public func openForWritingAndReading() throws -> SwifterFile {
         return try openFileForMode(self, "r+b")
     }

     public func openFileForMode(_ path: String, _ mode: String) throws -> SwifterFile {
