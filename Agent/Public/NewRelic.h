 ...
 *
 * @param identifier The identifier value to mask
 * @return true if the identifier was successfully added to the mask list
 */
 ...
 *
 * @param identifier The identifier value to unmask
 * @return true if the identifier was successfully added to the unmask list
 */
