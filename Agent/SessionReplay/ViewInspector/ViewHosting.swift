...
public extension ViewHosting {
    ...
    private static func host<V>(view: V, size: CGSize? = nil, viewId: ViewId) where V: View {
        let medium = { () -> ViewInspectorContent.Medium in
    ...
    internal static func medium(function: String = #function) -> ViewInspectorContent.Medium {
...
private extension ViewHosting {
    ...
    struct Hosted {
        ...
        #endif
        let medium: ViewInspectorContent.Medium
    }
