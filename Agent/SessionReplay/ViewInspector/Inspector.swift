...
internal extension Inspector {
    ...
    @MainActor
    #endif
    private static func attributesTree(value: Any, medium: ViewInspectorContent.Medium, visited: [AnyObject]) -> Any {
        var visited = visited
        ...
        let medium = (try? unwrap(content: ViewInspectorContent(value, medium: medium)).medium) ?? medium
...
internal extension Inspector {
    ...
    @MainActor
    #endif
    static func viewsInContainer(view: Any, medium: ViewInspectorContent.Medium) throws -> LazyGroup<ViewInspectorContent> {
        let unwrappedContainer = try Inspector.unwrap(content: ViewInspectorContent(view, medium: medium.resettingViewModifiers()))
    ...
    @MainActor
    #endif
    static func unwrap(view: Any, medium: ViewInspectorContent.Medium) throws -> ViewInspectorContent {
        return try unwrap(content: ViewInspectorContent(view, medium: medium))
    }
    ...
    static func unwrap(content: ViewInspectorContent) throws -> ViewInspectorContent {
