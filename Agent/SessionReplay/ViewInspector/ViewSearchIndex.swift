...
internal extension ViewSearch {
    ...
    private static func identify(_ content: ViewInspectorContent) -> ViewIdentity? {
...
internal extension ViewSearch {
    ...
    struct ViewIdentity {
        ...
        typealias ViewBuilder = @MainActor (ViewInspectorContent, UnwrappedView?, Int?) throws -> UnwrappedView
...
@available(iOS 13.0, macOS 10.15, tvOS 13.0, *)
private extension LazyGroup where T == ViewInspectorContent {
...
@available(iOS 13.0, macOS 10.15, tvOS 13.0, *)
private extension ViewInspectorContent {
