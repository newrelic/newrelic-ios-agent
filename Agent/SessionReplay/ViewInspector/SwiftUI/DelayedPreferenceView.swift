...
extension ViewType.DelayedPreferenceView: SingleViewContent {
    ...
    static func child(_ content: ViewInspectorContent) throws -> ViewInspectorContent {
        ...
        return try Inspector.unwrap(content: ViewInspectorContent(view, medium: content.medium))
    }
}
...
extension ViewType.PreferenceReadingView: SingleViewContent {
    ...
    static func child(_ content: ViewInspectorContent) throws -> ViewInspectorContent {
        ...
        return try Inspector.unwrap(content: ViewInspectorContent(view, medium: medium))
    }
}
...
extension _PreferenceReadingView: SingleViewProvider {
    func view() throws -> Any {
        typealias Builder = (Key.Value) -> ViewInspectorContent
