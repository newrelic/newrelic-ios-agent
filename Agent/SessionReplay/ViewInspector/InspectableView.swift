...
public struct InspectableView<View> where View: BaseViewType {
    ...
    // use or not
    internal let content: ViewInspectorContent
    // 
    ...
    internal init(_ content: ViewInspectorContent, parent: UnwrappedView?,
    ...
    private static func build(content: ViewInspectorContent, parent: UnwrappedView?, call: String, index: Int?) throws -> Self {
    ...
    private init(content: ViewInspectorContent, parent: UnwrappedView?, call: String, index: Int?) {
...
extension UnwrappedView {
    ...
    -> (content: ViewInspectorContent, parent: InspectableView<ViewType.View<ViewType.Stub>>)? {
...
internal protocol UnwrappedView {
    var content: ViewInspectorContent { get }
...
internal extension InspectableView where View: SingleViewContent {
    func child() throws -> ViewInspectorContent {
...
internal extension InspectableView where View: MultipleViewContent {
    ...
    func child(at index: Int, isTupleExtraction: Bool = false) throws -> ViewInspectorContent {
...
internal extension InspectableView {
    ...
    var contentForModifierLookup: ViewInspectorContent {
...
@available(iOS 13.0, macOS 10.15, tvOS 13.0, *)
internal extension ViewInspectorContent {
