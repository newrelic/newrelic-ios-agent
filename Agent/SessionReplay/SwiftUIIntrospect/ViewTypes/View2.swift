...
/// }
/// ```
public struct IntrospectViewType: IntrospectableViewType {}

extension IntrospectableViewType where Self == IntrospectViewType {
...
extension iOSViewVersion<IntrospectViewType, UIView> {
...
@available(iOS 13.0.0, *)
extension tvOSViewVersion<IntrospectViewType, UIView> {
    public static let v13 = Self(for: .v13)
    public static let v14 = Self(for: .v14)
    public static let v15 = Self(for: .v15)
    public static let v16 = Self(for: .v16)
...
@available(iOS 13.0.0, *)
extension visionOSViewVersion<IntrospectViewType, UIView> {
