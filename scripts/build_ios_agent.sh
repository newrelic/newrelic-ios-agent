...
/usr/bin/xcodebuild -configuration Release -scheme Agent-iOS -sdk iphoneos clean archive BUILD_LIBRARIES_FOR_DISTRIBUTION=YES -archivePath iOS.xcarchive > build.out 2>&1
